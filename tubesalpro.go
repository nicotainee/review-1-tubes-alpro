	...
	cek = false
		...
		fmt.Println("==========================================================")
			...
			if pilihan == 1 {
				...
				fmt.Println("==========================================================")
				fmt.Println("ID :", A[binarySearchNama(A,n,tarbin)].id)
      		    fmt.Println("Kategori    :", A[binarySearchNama(A,n,tarbin)].kategori)
       			fmt.Println("Nama        :", A[binarySearchNama(A,n,tarbin)].nama)
        		fmt.Println("Jumlah      :", A[binarySearchNama(A,n,tarbin)].jumlah)
        		fmt.Printf("Kadaluarsa  : %02d %02d %04d\n", A[binarySearchNama(A,n,tarbin)].kadarluarsa.no,  A[binarySearchNama(A,n,tarbin)].kadarluarsa.bulan, A[binarySearchNama(A,n,tarbin)].kadarluarsa.tahun)
				fmt.Println("==========================================================")
				fmt.Println()
				} else {
				...
				fmt.Println("==========================================================")
				fmt.Println("ID :", A[cariId(A, n,tarSeq)].id)
      		    fmt.Println("Kategori    :", A[cariId(A, n,tarSeq)].kategori)
       			fmt.Println("Nama        :", A[cariId(A, n,tarSeq)].nama)
        		fmt.Println("Jumlah      :", A[cariId(A, n,tarSeq)].jumlah)
        		fmt.Printf("Kadaluarsa  : %02d %02d %04d\n", A[cariId(A, n,tarSeq)].kadarluarsa.no,  A[cariId(A, n,tarSeq)].kadarluarsa.bulan, A[cariId(A, n,tarSeq)].kadarluarsa.tahun)
				fmt.Println("==========================================================")
				fmt.Println()
				} else {
					fmt.Println("Data tidak ditemukan")
...
// F.S.: Jumlah bahan pada ID yang sesuai bertambah sesuai input user
...
// F.S.: Menampilkan data bahan sesuai nama jika ditemukan
...
// F.S.: Menampilkan data bahan sesuai ID jika ditemukan
	...
	for i = 0; i < *n; i++ {
		if (*A)[i].id == id {
			...
			*n--
			...
			fmt.Print("Masukkan jumlah bahan yang sudah digunakan")
			fmt.Scan(&jumlah)
		} else {
